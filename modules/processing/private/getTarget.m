function [xT,pars] = getTarget(Target,xP,pars,options,multiplicador)
%% Constants
...
% Original code  %  DEFAULTTARGETPARS = struct('maxFlag',false,'avg2Flag',false,'avgPower',3,'note','','avg2dontAsk',false);
DEFAULTTARGETPARS = struct('maxFlag',false,'avg2Flag',false,'avgPower',multiplicador,'note','','avg2dontAsk',false); % Modified code
...
% Original code  %  pars.avgPower = input('Input multiplier for the 2nd average [default is 3]: ');
                pars.avgPower = multiplicador; % Modified code
                pars.avg2dontAsk = true;
% Original code  %  if (isempty(pars.avgPower)); pars.avgPower = 3; end
                if (isempty(pars.avgPower)); pars.avgPower = multiplicador; end % Modified code
            end
